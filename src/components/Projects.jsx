...
const projects = [
 {
  ...
  },
  {
    ...
    title: "TO-DO List",
    emoji: "✅",
    desc: "A clean, functional task manager app where you can add, complete, and delete tasks. Built with vanilla JS with local storage persistence.",
    tags: ["HTML", "CSS", "JavaScript"],
    live: "https://todolistbyjiwan.netlify.app/",
    github: "https://github.com/Karsh978",
    color: "#1a56db",
    //featured: true,
  },
